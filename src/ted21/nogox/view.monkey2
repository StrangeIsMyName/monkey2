...
Class NoView
	...
	#end
	Property NoStyle:NoStyle()
	
		Return _style
		
	Setter( style:NoStyle )
	...
	Method ValidateStyle()
		...
		If Not (_dirty & Dirty.NoStyle) Return
